...
class Walker_TCB_Nav_Menu_Edit extends Walker_Nav_Menu_Edit {
			...
			<p class="show-when">
				<label for="edit-menu-item-show-<?php echo $item_id; ?>"><?php echo esc_html__( 'Show when', 'thrive-cb' ) ?><br>
					<select class="tcb-show-when" name="tcb_show_when[<?php echo $item_id; ?>]" id="edit-menu-item-show-<?php echo $item_id; ?>">
						<option <?php echo $this->_selected( 'always', $item ); ?> data-orig="true" value="always"><?php echo esc_html__( 'Always', 'thrive-cb' ) ?></option>
						<option <?php echo $this->_selected( 'loggedout', $item ); ?> data-orig="true" value="loggedout">Logged out</option>
						<option <?php echo $this->_selected( 'loggedin', $item ); ?> data-orig="true" value="loggedin">Logged in</option>
					</select>
				</label>
			</p>
	...
	/**
	 * Compares $value with show when prop set on $item
	 *
	 * @param string  $value
	 * @param WP_Post $item
	 *
	 * @return string
	 */
	public function _selected( $value, $item ) {

		if ( false === $item instanceof WP_Post || empty( $item->tcb_show_when ) ) {
			return '';
		}

		$set_value = $item->tcb_show_when;

		return $value === $set_value ? 'selected="selected"' : '';
	}
